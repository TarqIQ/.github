...
## Mission
To build lightweight, extensible frameworks that unify knowledge graphs, machine learning, and chemical/biomedical data for accelerated discovery.

## Get Started
Clone any repository and follow its README:
```bash
git clone https://github.com/TarqIQ/<repository>.git
```

## Contributing
Pull requests and issues are welcome across all repositories.


## Contact
For inquiries or collaboration: research@tarqiq.org
